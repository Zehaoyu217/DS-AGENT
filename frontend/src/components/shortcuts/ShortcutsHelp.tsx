      ...
      <Dialog.Portal>
        ...
        >
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-surface-800 flex-shrink-0">
            <div>
              ...
              <Dialog.Description className="text-xs text-surface-500 mt-0.5">
                Press{' '}
                <kbd className="inline-flex items-center h-4 px-1 rounded bg-surface-800 border border-surface-700 text-[10px] font-mono">
                  ?
                </kbd>{' '}
          ...
          <div className="overflow-y-auto flex-1 px-4 py-3 space-y-5">
            {groups.length === 0 ? (
              <p className="text-center text-sm text-surface-500 py-8">No shortcuts found</p>
            ) : (
